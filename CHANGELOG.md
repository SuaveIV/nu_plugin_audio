...
* Update Justfile
 - <csr-id-645d6da0769208b9b0cc3bbb3cd39e79a4020940/> update release process to prevent GitHub changelog generation
 ...
 * **Uncategorized**
    - Update release process to prevent GitHub changelog generation ([`645d6da`](https://github.com/SuaveIV/nu_plugin_audio/commit/645d6da0769208b9b0cc3bbb3cd39e79a4020940))
    - Release nu_plugin_audio v0.2.7 ([`0be0852`](https://github.com/SuaveIV/nu_plugin_audio/commit/0be085295b437e77a45f7edf3946495ebfd78061))
...
### New Features
 ...
 - <csr-id-74fadd64148c1857f8bf51cdad3bddba38931d3c/> add CodeQL workflow for Rust analysis
 ...
 * **[#19](https://github.com/SuaveIV/nu_plugin_audio/issues/19)**
    - Migrate to Dependabot and secure release workflow ([`6964f18`](https://github.com/SuaveIV/nu_plugin_audio/commit/6964f18835a5f532d2f65ca4510f6b637d8563bf))
 * **[#20](https://github.com/SuaveIV/nu_plugin_audio/issues/20)**
    - Bump softprops/action-gh-release from 2.5.0 to 2.6.0 ([`8745780`](https://github.com/SuaveIV/nu_plugin_audio/commit/8745780de8137a8fbd2a05f047d4571d5cd6e30b))
 * **[#21](https://github.com/SuaveIV/nu_plugin_audio/issues/21)**
    - Bump actions/download-artifact from 8.0.0 to 8.0.1 ([`b8f00a1`](https://github.com/SuaveIV/nu_plugin_audio/commit/b8f00a103722ceb5cb5efd078df77cbc4f547086))
 * **[#22](https://github.com/SuaveIV/nu_plugin_audio/issues/22)**
    - Bump lofty from 0.23.2 to 0.23.3 ([`568ce4c`](https://github.com/SuaveIV/nu_plugin_audio/commit/568ce4cd2641e2ef136abc23a8b103bbf746d803))
 * **[#23](https://github.com/SuaveIV/nu_plugin_audio/issues/23)**
    - Remove minimp3 decoder to resolve RUSTSEC-2025-0044 ([`4eaa795`](https://github.com/SuaveIV/nu_plugin_audio/commit/4eaa7954fee9a3580365c3816e18883b285f0965))
 * **[#25](https://github.com/SuaveIV/nu_plugin_audio/issues/25)**
    - Fold all-decoders into default feature set ([`051fe87`](https://github.com/SuaveIV/nu_plugin_audio/commit/051fe87727d68817a0f2764cd50c0cc0306b3329))
 * **[#28](https://github.com/SuaveIV/nu_plugin_audio/issues/28)**
    - Create codeql.yml ([`4420b4a`](https://github.com/SuaveIV/nu_plugin_audio/commit/4420b4a2660168a99c57eeb6c95e52de6c3dccc9))
 * **[#29](https://github.com/SuaveIV/nu_plugin_audio/issues/29)**
    - Resolve tag from API instead of workflow_run context ([`5b18f3d`](https://github.com/SuaveIV/nu_plugin_audio/commit/5b18f3d8e6cbfe3ad949b20e8a75f038512c100a))
 * **[#30](https://github.com/SuaveIV/nu_plugin_audio/issues/30)**
    - Bump github/codeql-action from 3 to 4 ([`9d3010c`](https://github.com/SuaveIV/nu_plugin_audio/commit/9d3010cacceabd79f4737a5edba0ee77df071312))
 * **[#31](https://github.com/SuaveIV/nu_plugin_audio/issues/31)**
    - Bump softprops/action-gh-release from 2.6.0 to 2.6.1 ([`187da08`](https://github.com/SuaveIV/nu_plugin_audio/commit/187da08880bfccd95ec1d336e841077c8b678685))
 * **[#33](https://github.com/SuaveIV/nu_plugin_audio/issues/33)**
    - Bump actions/upload-artifact from 7.0.0 to 7.0.1 ([`a2ca52d`](https://github.com/SuaveIV/nu_plugin_audio/commit/a2ca52d0e1c35506f17a2bd97da8547029f965f4))
 * **[#34](https://github.com/SuaveIV/nu_plugin_audio/issues/34)**
    - Bump softprops/action-gh-release from 2.6.1 to 3.0.0 ([`3032429`](https://github.com/SuaveIV/nu_plugin_audio/commit/3032429c408d49f1845eb74892624a4f0aac2f48))
 ...
 * **Uncategorized**
    ...
    - Add CodeQL workflow for Rust analysis ([`74fadd6`](https://github.com/SuaveIV/nu_plugin_audio/commit/74fadd64148c1857f8bf51cdad3bddba38931d3c))
    - Update CONTRIBUTING guidelines and .gitignore for temp files ([`0933c1b`](https://github.com/SuaveIV/nu_plugin_audio/commit/0933c1ba1c9d0c62eed125097a253c884e21e38d))
    - Update release process to tag and push version after smart-release ([`6b052a9`](https://github.com/SuaveIV/nu_plugin_audio/commit/6b052a9ad884dac88b1e95a56dde237bda1f8cbb))
